...
**Fase corrente: F-DEBT (F5 completata e mergiata su master, 2026-07-16, 10/10 task, PR#1).** 5 task di debito tecnico non bloccante registrati in `docs/TECH-DEBT.md`, nessuno ancora iniziato.
