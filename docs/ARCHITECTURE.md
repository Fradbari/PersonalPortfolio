...
Fase corrente: F4 (F3 completata e verificata il 2026-07-14 — dashboard Metabase su replica R/O).   ← AGGIORNARE
Sottoagente da attivare: backup-agent (dump SQLite + export .xlsx, Google Drive Service Account, ADR-0008).
