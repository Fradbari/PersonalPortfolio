...
- **Sottoagenti di progetto** — richiamati in CLAUDE.md, collegati a skill superpower generale; uno per dominio (ingestion, schema/migrazioni, dashboard, backup).
...
Fase corrente: F5 (F4 completata e verificata il 2026-07-14 — backup manuale + startup opzionale, locale+Drive, restore testato E2E).   ← AGGIORNARE
Sottoagente da attivare: nessuno dedicato ancora per F5 (UI React) — valutare crearne uno in CLAUDE.md quando la fase parte.
